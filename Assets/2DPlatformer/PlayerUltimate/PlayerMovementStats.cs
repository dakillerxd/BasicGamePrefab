...
public class PlayerMovementStats : ScriptableObject
{
    ...
    [Range(1f,1.1f)] public float JumpHightCompensationFactor = 1.054f;
    ...
    [Header("Jump Buffer")]
    [Range(0f, 15f)] public float JumpBufferTime = 0.125f;

    [Header("Jump CoyoteTime")]
    ...
    private void CalculateValues() {
        ...
        AdjustedJumpHeight = JumpHeight * JumpHightCompensationFactor;
        Gravity = -(2 * JumpHeight) / Mathf.Pow(TimeTillJumpApex, 2f);
